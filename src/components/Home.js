...
const Home = () => (
  <>
    ...
    <div class='container'>
      <p class='home-header'> Draper Chiropractor </p>
      <p class='text-block'>
    ...
    <div class='container' style={{ paddingBottom: '3rem'}}>
      ...
      <Link class='button' to='/services' style={{ textDecoration: 'none' }}>
        See our services
      </Link>
      ...
      <Link class='button' to='/contact' style={{ textDecoration: 'none' }}>
        Contact us
      </Link>
    </div>
  </>
