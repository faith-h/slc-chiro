  ...
  <>
    ...
    <div class='section'>
      <div class='section-content'>
        ...
        <p class='text-block'> When it comes to your health, our office delivers a range of services designed to restore your body to balance.
        ...
        <p class='home-header' style={{ paddingBottom: '3rem', paddingTop: '2rem', textAlign: 'center' }}> We offer the following services: </p>

        <div class='grid' style={{ textAlign: 'center', gap: '3rem' }}>
          <div>
            <img class='page-icon' src="https://www.flaticon.com/svg/static/icons/svg/822/822222.svg" alt="Injury Treatment Icon" />
          ...
          <div>
            <img class='page-icon' src="https://www.flaticon.com/svg/static/icons/svg/890/890806.svg" alt="Medsonix Therapy Icon" />
          ...
          <div>
            <img class='page-icon' src="https://www.flaticon.com/svg/static/icons/svg/2817/2817872.svg" alt="Athletic Therapy Icon" />
        ...
        <div class='grid' id='grid-helper' style={{ textAlign: 'center' }}>
          <div>
            <img class='page-icon' src="https://www.flaticon.com/svg/static/icons/svg/2222/2222477.svg" alt="Manipulation and Adjustments Icon" />
          ...
          <div>
            <img class='page-icon' src="https://www.flaticon.com/svg/static/icons/svg/2966/2966334.svg" alt="Personal Treatment Plans Icon" />
